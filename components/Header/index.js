...
const Header = ({
  ...
  const emailLink =
    data.socials.find((social) => social.title.toLowerCase() === "email")
      ?.link || "mailto:helloaybyrn@gmail.com";
            ...
            >
              {!isBlog ? (
                <div className="grid grid-cols-1">
                  ...
                  <Button onClick={handleCoursesScroll}>Certifications</Button>
                  <Button onClick={handleAboutScroll}>About</Button>
                  {showBlog && (
                    <Button onClick={() => router.push("/blog")}>Blog</Button>
                  )}
                  <Button onClick={() => window.open(emailLink)}>Contact</Button>
                </div>
              ) : (
                <div className="grid grid-cols-1">
